...
| Board-game snake icon | `public/assets/icons/snake/snake-64.png` | https://www.flaticon.com/free-icons/board-game | Freepik / Flaticon | Flaticon Free License, atribuição obrigatória | OK | Usado como ícone do app mobile `snake.apk` no RafaDroid. |
