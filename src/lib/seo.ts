...
export const siteUrl = "https://rafaelprado.dev";
...
export const ogImage = {
  ...
  width: 1200,
  height: 630,
  alt: "Rafael Prado, Desenvolvedor Front-End especializado em React.js, Next.js e TypeScript.",
};
...
export const linkedInUrl = "https://www.linkedin.com/in/rafaelpradodev/";
